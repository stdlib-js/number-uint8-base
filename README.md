...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint8-base@v0.2.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { fromBinaryStringUint8, toBinaryStringUint8 } from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint8-base@v0.2.1-esm/index.mjs';
```
