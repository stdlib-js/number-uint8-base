...
```
The previous example will load the latest bundled code from the deno branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/number-uint8-base/tags). For example,

```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint8-base@v0.2.3-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { add, fromBinaryStringUint8, identity, mul, sub, toBinaryStringUint8 } from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint8-base@deno/mod.js';
```
...
[@stdlib/number/uint8/base/add]: https://github.com/stdlib-js/number-uint8-base-add/tree/deno

[@stdlib/number/uint8/base/from-binary-string]: https://github.com/stdlib-js/number-uint8-base-from-binary-string/tree/deno

[@stdlib/number/uint8/base/identity]: https://github.com/stdlib-js/number-uint8-base-identity/tree/deno

[@stdlib/number/uint8/base/mul]: https://github.com/stdlib-js/number-uint8-base-mul/tree/deno

[@stdlib/number/uint8/base/sub]: https://github.com/stdlib-js/number-uint8-base-sub/tree/deno
