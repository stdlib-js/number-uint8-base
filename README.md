...
```javascript
ns = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint8-base@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/number-uint8-base/tags). For example,

```javascript
ns = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint8-base@v0.2.3-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var ns = require( 'path/to/vendor/umd/number-uint8-base/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/number-uint8-base@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/number-uint8-base/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/number-uint8-base/actions/workflows/test.yml?query=branch:v0.2.3
...
[@stdlib/number/uint8/base/add]: https://github.com/stdlib-js/number-uint8-base-add/tree/umd

[@stdlib/number/uint8/base/from-binary-string]: https://github.com/stdlib-js/number-uint8-base-from-binary-string/tree/umd

[@stdlib/number/uint8/base/identity]: https://github.com/stdlib-js/number-uint8-base-identity/tree/umd

[@stdlib/number/uint8/base/mul]: https://github.com/stdlib-js/number-uint8-base-mul/tree/umd

[@stdlib/number/uint8/base/sub]: https://github.com/stdlib-js/number-uint8-base-sub/tree/umd
